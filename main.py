...
from data.build_h5 import make_h5_dataset
from data.loader_from_h5 import construct_dataloader_from_h5
...
for atom_fea, atom_3d, edge, res_idx, affinity in loader:

    print(np.shape(atom_fea))
    pass
